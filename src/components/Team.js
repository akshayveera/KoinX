...
const Team = () => {
  return (
    <div className='bg-white p-7 flex flex-col gap-5 rounded-lg '>
        ...
        <div className='flex bg-blue-50 py-3 px-10 rounded-lg items-center justify-between'>
        ...
        <div className='flex bg-blue-50 py-3 px-10 rounded-lg items-center justify-between'>
            <div className='flex flex-col items-center gap-2'>
                ...
                alt="image of Guna Shekar Proddaturi"
                className='h-32 w-32 object-fill rounded-lg' />
                <div className='flex flex-col items-center'>
