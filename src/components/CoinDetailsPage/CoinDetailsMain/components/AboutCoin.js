...
const AboutCoin = () => {
  return (
    <div className='bg-white p-7 rounded-lg flex flex-col gap-5'>
        <h1 className='text-2xl font-semibold'>About Cryptocurrency</h1>

        <div className='flex flex-col gap-3 py-3 border-b-2'>
            <h2 className='text-xl font-semibold'>What is Cryptocurrency?</h2>
            <p className=' font-semibold text-gray-700'>A cryptocurrency, crypto-currency, or crypto is a digital currency designed to work as a medium of exchange through a computer network that is not reliant on any central authority, such as a government or bank, to uphold or maintain it</p>
        </div>
        ...
        <div className='flex flex-col gap-3 py-3 border-b-2'>
            ...
            <p className=' font-semibold text-gray-700'>Nemo neque quo rerum omnis esse laboriosam, accusamus explicabo velit quaerat deleniti doloremque, repellat sequi optio, unde et culpa. Aperiam voluptatem nam consectetur hic reprehenderit! Repellendus saepe officiis enim. Quaerat, asperiores!</p>
        </div>
        ...
        <div className='flex flex-col gap-3 py-3 pb-5 border-b-2 '>
            ...
            <div className='md:flex-row md:gap-0 flex flex-col gap-5 justify-between'>
                <div className='md:w-[47%] w-full bg-gradient-to-br from-green-400 to-blue-400 flex p-5 rounded-lg gap-5 items-center'>
                    <img 
                ...
                <div className='md:w-[47%] w-full bg-gradient-to-br from-orange-300 to-red-500 flex p-5 rounded-lg gap-5 items-center'>
                    <img 
        ...
        <p className=' font-semibold text-gray-700'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatibus cum minima voluptates facilis dolores magnam neque excepturi quidem esse quis, blanditiis maxime iste nulla tenetur, possimus numquam libero quos vel!</p>
    </div>
  )
}
